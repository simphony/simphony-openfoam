...
namespace Foam
{
    defineTypeNameAndDebug(simpleControlMod, 0);
}


// * * * * * * * * * * * * Protected Member Functions  * * * * * * * * * * * //

void Foam::simpleControlMod::read()
{
    solutionControl::read(true);
}


bool Foam::simpleControlMod::criteriaSatisfied()
{
...
Foam::simpleControlMod::simpleControlMod(fvMesh& mesh)
:
...
Foam::simpleControlMod::~simpleControlMod()
{}


// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

bool Foam::simpleControlMod::loop()
{
    read();
