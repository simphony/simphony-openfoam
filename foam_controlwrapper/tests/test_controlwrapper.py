...
class WrapperTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.cuds.add(Cfd(name='default cfd model'))
        self.cuds.add(self.mesh)
    ...
    def test_get_dataset(self):
        ...
        for point in self.mesh._iter_points():
            ...
            point_f = mesh_inside_wrapper._get_point(puid)
        ...
        for cell in self.mesh._iter_cells():
            ...
            cell_f = mesh_inside_wrapper._get_cell(cuid)
    ...
    def test_multiple_meshes(self):
        ...
        self.assertEqual(
            sum(1 for _ in mesh_inside_wrapper1._iter_points()),
            sum(1 for _ in mesh_inside_wrapper2._iter_points()))
